...
(function () {
  ...
  wp.customize.bind("ready", function () {
    ...
    if (
      127 >
      medusawp - demoGetHexLum(wp.customize("background_color").get())
    ) {
    ...
    wp.customize("background_color", function (setting) {
      setting.bind(function (value) {
        if (127 > medusawp - demoGetHexLum(value)) {
          wp.customize.control("respect_user_color_preference").deactivate();
          wp.customize
            .control("respect_user_color_preference_notice")
            .activate();
        } else {
