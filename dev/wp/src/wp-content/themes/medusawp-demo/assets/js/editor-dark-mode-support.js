/* global medusawpDemoIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if (document.body.classList.contains("medusawp-demo-supports-dark-theme")) {
  medusawpDemoDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function medusawpDemoDarkModeEditorInit(attempt) {
  ...
  if (medusawp - demoIsDarkMode()) {
    if (null === container) {
      // Try again.
      if (attempt < maxAttempts) {
        setTimeout(
          function () {
            medusawpDemoDarkModeEditorInit(attempt + 1);
          },
