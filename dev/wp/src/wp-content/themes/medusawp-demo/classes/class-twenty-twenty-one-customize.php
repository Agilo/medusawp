...
if ( ! class_exists( 'MedusaWP_Demo_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since MedusaWP Demo 1.0
	 */
	class MedusaWP_Demo_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'medusawp-demo' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'medusawp-demo' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'medusawp-demo' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'medusawp-demo' ),
						'full'    => esc_html__( 'Full text', 'medusawp-demo' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'MedusaWP_Demo_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new MedusaWP_Demo_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'medusawp-demo' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
